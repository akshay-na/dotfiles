...
- Persist durable output under **`~/ai-brain/`** (per **`brain-conventions.md`**) in namespaces such as `projects/<name>/growth/`, `org/global/content/growth-intel/`, or paths your **`cco`** plan names.
...
- **Subagents:** structured envelope per **`subagent-response-protocol.md`** when you are a child agent.
