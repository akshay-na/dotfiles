...
For `cco`, `content-lead`, and `editorial-cro`, the following fields are mandatory on every `log_subagent_audit` entry:
...
alternatives_considered: ["staff-engineer", "narrow scope and continue with content-lead"]
