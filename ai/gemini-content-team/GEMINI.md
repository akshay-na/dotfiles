...
| Agent             | File                        | Role                                                                                                                                                                                                                               |
| ----------------- | --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `cco`             | `agents/cco.md`             | Chief Content Officer — planning entrypoint; editorial phases; post–v0 edit round; **`editorial-cro-loop`** at execution intent (before **`content-lead`**); delegates to org specialists; does **not** replace **`content-lead`** for repo execution.                                      |
