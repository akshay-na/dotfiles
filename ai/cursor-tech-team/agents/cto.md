...
0. **Plan v0 written.** Specialist consultation done. Plan synthesized. File persisted under `<project>/.cursor/docs/plans/`. Only after this step do you start the loop.
