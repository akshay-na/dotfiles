...
- **Editorial pipeline durable tree:** **`~/ai-brain/projects/<project_name>/`** — **`project_name`** from git or folder (**`rules/project-identity.md`**, **`skills/project-identity/SKILL.md`**); or absolute **`GEMINI_CONTENT_BRAIN`** bypass. See **`rules/content-brain-paths.md`**.
