...
Read `rules/orchestration.md`, `rules/repo-hygiene.md`, `rules/project-identity.md`, `skills/project-identity/SKILL.md`, `rules/content-brain-paths.md`, `rules/brain-conventions.md`, and `rules/cco-single-invocation.md` first.
