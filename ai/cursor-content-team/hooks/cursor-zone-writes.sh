...
#     $HOME/dotfiles/ai/cursor-content-team/docs/**
#     $HOME/dotfiles/ai/cursor-content-team/memory/**
...
STOW_DOCS="$HOME/dotfiles/ai/cursor-content-team/docs"
STOW_MEM="$HOME/dotfiles/ai/cursor-content-team/memory"
