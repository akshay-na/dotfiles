...
2. Org-level agents live in the **content pack** (stowed ~/.cursor/agents/):
...
5. Return status (never treat org-tier content-lead file under ~/.cursor/agents as repo team presence)
```
