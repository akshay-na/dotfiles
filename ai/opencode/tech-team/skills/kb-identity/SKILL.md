...
- Determine the KB path: `~/ai-brain/projects/<project_name>/`
...
Output:
    ...
    kb_path: "/Users/dev/.opencode/ai-brain/projects/myapp/"
...
Output:
    ...
    kb_path: "/Users/dev/.opencode/ai-brain/projects/local-project/"
    remote_url: null
    is_worktree: false
    derived_from: "folder_name"
```
