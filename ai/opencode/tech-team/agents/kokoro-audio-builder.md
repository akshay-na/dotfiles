...
- **Do not** bypass **`kokoro-audio-builder-governance.md`** or **`remotion-builder-governance.md`** for **ffmpeg** graphs.
...
- **`ai/opencode/tech-team/rules/kokoro-audio-builder-governance.md`** (this pack) — non-bypass.
