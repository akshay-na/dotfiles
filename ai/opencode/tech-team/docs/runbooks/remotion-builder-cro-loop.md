...
- Plan v0 exists at **`<project>/.opencode/docs/plans/YYYY-MM-DD-remotion-<slug>.md`**.
...
- Path: **`~/ai-brain/session/<task-id>/critic-ledger.md`** (or **`opencode-<task-id>`** prefix per active **`brain-conventions`** session layout).
...
- Org **`cro-loop`** skill: `ai/opencode/tech-team/skills/cro-loop/SKILL.md`
...
- Governance: `ai/opencode/tech-team/rules/remotion-builder-governance.md`
- **`subagent-response-protocol`**: `~/.config/opencode/rules/subagent-response-protocol.md`
