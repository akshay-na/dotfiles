...
#
# Template path:  ~/.config/opencode/templates/subagent-response.yml.tmpl
# Skill:          ~/.config/opencode/skills/subagent-response-protocol/SKILL.md
# Rule:           ~/.config/opencode/rules/subagent-response-protocol.md
...
`~/.config/opencode/templates/subagent-response.yml.tmpl`. Strict **caveman-ultra** for
