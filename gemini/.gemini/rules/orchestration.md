...
| `DRAFT` | G3 (parallel per channel) | `editor-blog`, `editor-twitter`, `editor-linkedin`, `editor-shorts` (incl. instagram/reels), `editor-newsletter` | `kb/40-Drafts/<channel>/` only for each |
